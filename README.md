...
- [Ace Editor](https://ace.c9.io/) - Code editor (BSD License)
- [Pyodide](https://pyodide.org/) - Python in the browser via WebAssembly (MPL-2.0)
- [marked.js](https://marked.js.org/) - Markdown rendering (MIT)
- [highlight.js](https://highlightjs.org/) - Syntax highlighting (BSD)
...
See [LICENSE.md](LICENSE.md) for full details including third-party licenses.
