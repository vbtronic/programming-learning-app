...
lessonTests: {
python: [
{id:1,title:{en:'Print Basics',cz:'Základy výpisu'},desc:{en:'Print "Hello World" on line 1, then print the result of 7 * 6 on line 2.',cz:'Vypiš "Hello World" na řádek 1, pak výsledek 7 * 6 na řádek 2.'},starter:'',expected:'Hello World\n42',keywords:['print'],maxScore:100},
...
{id:5,title:{en:'Sum 1 to N',cz:'Součet 1 až N'},desc:{en:'Calculate and print the sum of numbers from 1 to 100 using a loop.',cz:'Vypočítej a vypiš součet čísel od 1 do 100 pomocí cyklu.'},starter:'',expected:'5050',keywords:['for','range','print'],maxScore:100},
...
{id:12,title:{en:'Animal Classes',cz:'Třídy zvířat'},desc:{en:'Create class Dog with name and bark() returning "Woof!". Create rex = Dog("Rex"), print name and bark.',cz:'Vytvoř třídu Dog s name a bark() vracející "Woof!". Vytvoř rex = Dog("Rex"), vypiš jméno a bark.'},starter:'',expected:null,keywords:['class','def','self','__init__'],maxScore:100},
...
{id:14,title:{en:'Property & Magic',cz:'Property a magic'},desc:{en:'Create class Temperature with celsius property. Add __str__ returning "X°C". Test with 100.',cz:'Vytvoř třídu Temperature s property celsius. Přidej __str__ vracející "X°C". Testuj se 100.'},starter:'',expected:null,keywords:['class','@property','__str__'],maxScore:100},
{id:15,title:{en:'Comprehension Challenge',cz:'Comprehension výzva'},desc:{en:'Using list comprehension: create squares of even numbers from 1-20. Print the list.',cz:'Pomocí list comprehension: vytvoř čtverce sudých čísel z 1-20. Vypiš seznam.'},starter:'',expected:'[4, 16, 36, 64, 100, 144, 196, 256, 324, 400]',keywords:['for','if','**'],maxScore:100},
...
csharp: [
{id:1,title:{en:'Print Basics',cz:'Základy výpisu'},desc:{en:'Print "Hello World" then print 7 * 6.',cz:'Vypiš "Hello World" a pak 7 * 6.'},starter:'',expected:'Hello World\n42',keywords:['Console.WriteLine'],maxScore:100},
...
{id:5,title:{en:'Sum 1 to N',cz:'Součet 1 až N'},desc:{en:'Print sum of 1 to 100 using a loop.',cz:'Vypiš součet 1 až 100 cyklem.'},starter:'',expected:'5050',keywords:['for','Console.WriteLine'],maxScore:100},
...
{id:8,title:{en:'Max Finder',cz:'Hledač maxima'},desc:{en:'Write FindMax method for array. Test with {3,7,1,9,4}.',cz:'Napiš metodu FindMax pro pole. Testuj s {3,7,1,9,4}.'},starter:'',expected:'9',keywords:['FindMax','return','Console'],maxScore:100},
...
{id:11,title:{en:'Safe Division',cz:'Bezpečné dělení'},desc:{en:'SafeDivide(a,b) returning string. Test 10/2 and 10/0.',cz:'SafeDivide(a,b) vracející string. Test 10/2 a 10/0.'},starter:'',expected:'5\nError',keywords:['try','catch','Console'],maxScore:100},
{id:12,title:{en:'Dog Class',cz:'Třída Pes'},desc:{en:'Create Dog class with Name and Bark(). Print rex.Bark().',cz:'Vytvoř třídu Dog s Name a Bark(). Vypiš rex.Bark().'},starter:'',expected:null,keywords:['class','public','Bark'],maxScore:100},
{id:13,title:{en:'Shape Hierarchy',cz:'Hierarchie tvarů'},desc:{en:'Shape base, Circle : Shape with Area(). Print area r=5.',cz:'Základní Shape, Circle : Shape s Area(). Vypiš obsah r=5.'},starter:'',expected:null,keywords:['class','override','Area','Circle'],maxScore:100},
{id:14,title:{en:'Generic Box',cz:'Generická krabice'},desc:{en:'Create Box<T> with Value property. Test with int and string.',cz:'Vytvoř Box<T> s Value property. Testuj s int a string.'},starter:'',expected:null,keywords:['class','Box','<T>','Value'],maxScore:100},
...
{id:16,title:{en:'Namespace Usage',cz:'Použití jmenných prostorů'},desc:{en:'Print Math.Sqrt(144), Math.PI rounded to 2 dec, Math.Pow(2,10).',cz:'Vypiš Math.Sqrt(144), Math.PI na 2 des., Math.Pow(2,10).'},starter:'',expected:'12\n3.14\n1024',keywords:['Math','Console.WriteLine'],maxScore:100},
{id:17,title:{en:'Selection Sort',cz:'Selection Sort'},desc:{en:'Implement SelectionSort for int[]. Sort {64,25,12,22,11}.',cz:'Implementuj SelectionSort. Seřaď {64,25,12,22,11}.'},starter:'',expected:'11 12 22 25 64',keywords:['SelectionSort','for','if'],maxScore:100},
...
{id:19,title:{en:'Calculator',cz:'Kalkulačka'},desc:{en:'Write Calc(string expr) for "10 + 5", "8 * 3", "20 / 4".',cz:'Napiš Calc(string expr) pro "10 + 5", "8 * 3", "20 / 4".'},starter:'',expected:'15\n24\n5',keywords:['Split','switch','Console'],maxScore:100},
{id:20,title:{en:'Todo App',cz:'Todo aplikace'},desc:{en:'TodoApp with Add, Complete, Show. Add 2 items, complete first, show.',cz:'TodoApp s Add, Complete, Show. Přidej 2, dokonči první, zobraz.'},starter:'',expected:null,keywords:['class','List','Add'],maxScore:100}
]},
